...
export default function Signup() {
    ...
    const { signup, loginWithGoogle, logout } = useAuth(); // Assuming signup takes email, password
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await logout(); // Force logout so user can login manually
            toast({
                title: "Account Created",
                description: "Account has created login to your account",
            });
            navigate('/login', { state: { successMessage: "Account has created login to your account" } });
        } catch (err) {
